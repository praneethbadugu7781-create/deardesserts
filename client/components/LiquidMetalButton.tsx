          ...
          >
            <div
              style={{
                ...
                margin: "2px",
                borderRadius: "100px",
                background: "linear-gradient(180deg, #2D1A10 0%, #0F0906 100%)",
                boxShadow: isPressed
          ...
          >
            <div
              style={{
                ...
                borderRadius: "100px",
                boxShadow: isHovered
                  ? "0px 0px 15px rgba(212, 175, 55, 0.4), 0px 8px 12px rgba(0, 0, 0, 0.3)"
                  : "0px 0px 0px 1px rgba(74, 46, 27, 0.5), 0px 4px 10px rgba(0, 0, 0, 0.25)",
